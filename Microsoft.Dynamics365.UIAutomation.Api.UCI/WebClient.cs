    ...
    public class WebClient : BrowserPage, IDisposable
    {
        ...
        private LoginResult Login(IWebDriver driver, Uri uri, SecureString username, SecureString password, SecureString mfaSecretKey = null, Action<LoginRedirectEventArgs> redirectAction = null)
        {
            ...
            if (!waitingForOtc)
            {
                ...
                //ClickSendNotificatioButton(driver);
        ...
        private bool ClickSendNotificatioButton(IWebDriver driver)
        {
            var input = driver.WaitUntilAvailable(By.XPath(Elements.Xpath[Reference.Login.UserId.Replace("email","submit")]), new TimeSpan(0, 0, 30));
            if (input == null)
                return false;
